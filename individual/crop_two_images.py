...
img_ori_name = args.img1.split('/')[-1].split('.')[0]
img1_save_name = img_ori_name + f'_{start_h}_{start_w}_{crop_h}_{crop_w}_img1.png'
img2_save_name = img_ori_name + f'_{start_h}_{start_w}_{crop_h}_{crop_w}_img2.png'
cv2.imwrite(img1_save_name, img1_patch)
cv2.imwrite(img2_save_name, img2_patch)
print(f'img1 saved at {img1_save_name}')
print(f'img2 saved at {img2_save_name}')
